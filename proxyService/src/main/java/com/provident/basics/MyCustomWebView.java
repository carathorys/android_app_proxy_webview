...
public class MyCustomWebView extends Fragment implements MyWebViewClient.OnUrlChangeListener {
    ...
    public boolean mIsProxyEnabled = false;
    ...
    private long mInbound = 0, mOutbound = 0;
                    ...
                    callbackService.getProxyPort(new IProxyPortListener.Stub() {
                        ...
                        public void setProxyPort(final int port) throws RemoteException {
                            ...
                            if (port != -1) {
                                ...
                                ProxySettings.setProxy(getContext().getApplicationContext(), "localhost", mProxyPort);
    ...
    void initializeWebView() {
        ...
        floatingActionButton.setOnClickListener(c -> {
            try {
                if (mIsProxyEnabled) {
                    ProxySettings.disableProxy(getContext());
                    floatingActionButton.setBackgroundTintList(ColorStateList.valueOf(Color.RED));
                } else {
                    ProxySettings.setProxy(getContext(), "localhost", mProxyPort);
                    floatingActionButton.setBackgroundTintList(ColorStateList.valueOf(Color.GREEN));
                }
            } catch (Exception e) {
                e.printStackTrace();
