...
public class ProxyService extends Service {
    ...
    public IBinder onBind(Intent intent) {
        return new IProxyCallback.Stub() {
            ...
            @Override
            public void updateNotification(IBinder callback) throws RemoteException {
                if(server != null) {
                    IRequestUpdateNotification requestUpdateNotification = IRequestUpdateNotification.Stub.asInterface(callback);
                    if(requestUpdateNotification != null) {
                        server.setNotificationUpdated(requestUpdateNotification);
                    }
                }
            }
